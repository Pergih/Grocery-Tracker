...
def add_canonical_product(name):
    cursor.execute("INSERT INTO canonical_products (name) VALUES (?)", (name,))
    conn.commit()
...
def add_product(scraped_name, canonical_id, brand_id):
    cursor.execute("INSERT INTO products (scraped_name, canonical_id, brand_id) VALUES (?,?,?)", (scraped_name, canonical_id, brand_id))
    conn.commit()
    
def add_price(product_id, price, date):
    cursor.execute("INSERT INTO prices (product_id, store, date) VALUES (?, ?, ?)",
